...
- Exception: `extensions/` directory holds pi extension source (TypeScript). These are NOT part of kdev script itself.
...
| Prefix | Tests |
|--------|-------|
| H | Here command (cmd_here — no-worktree session) |
